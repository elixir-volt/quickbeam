...
Each selected path is run in a fresh native QuickJS runtime and through six BEAM
gates: copied and pinned interpreter evaluation, plus copied and pinned
release-quarantined `:pure_v1` and `:scalar_v1` compiler evaluation. Results are
classified as:
