...
[
  ...
  boundaries: [
    ...
    internal: [
      ...
      "QuickBEAM.VM.ObjectModel.BuiltinObjectGet",
      "QuickBEAM.VM.ObjectModel.BuiltinFunctionGet",
      "QuickBEAM.VM.ObjectModel.CallableOwnGet",
      ...
      "QuickBEAM.VM.ObjectModel.OrdinaryGet",
      "QuickBEAM.VM.ObjectModel.OwnGet",
    ...
    internal_callers: [
      ...
      {"QuickBEAM.VM.ObjectModel.CallableOwnGet",
       ["QuickBEAM.VM.ObjectModel.Get", "QuickBEAM.VM.ObjectModel.OwnGet"]},
      {"QuickBEAM.VM.ObjectModel.DateExoticGet",
       ["QuickBEAM.VM.ObjectModel.Get", "QuickBEAM.VM.ObjectModel.BuiltinObjectGet"]},
      {"QuickBEAM.VM.ObjectModel.ExplicitOwnProperty", ["QuickBEAM.VM.ObjectModel.Get"]},
      {"QuickBEAM.VM.ObjectModel.FunctionExoticGet",
       ["QuickBEAM.VM.ObjectModel.Get", "QuickBEAM.VM.ObjectModel.CallableOwnGet"]},
      {"QuickBEAM.VM.ObjectModel.FunctionPrototypeGet",
       [
      ...
      {"QuickBEAM.VM.ObjectModel.ObjectMapGet",
       ["QuickBEAM.VM.ObjectModel.Get", "QuickBEAM.VM.ObjectModel.OwnGet"]},
      {"QuickBEAM.VM.ObjectModel.OrdinaryGet", ["QuickBEAM.VM.ObjectModel.Get"]},
      {"QuickBEAM.VM.ObjectModel.OwnGet", ["QuickBEAM.VM.ObjectModel.Get"]},
      {"QuickBEAM.VM.ObjectModel.PrimitiveExoticGet",
       ["QuickBEAM.VM.ObjectModel.Get", "QuickBEAM.VM.ObjectModel.PrototypeGet"]},
      {"QuickBEAM.VM.ObjectModel.PrimitiveWrapperGet",
       [
      ...
      {"QuickBEAM.VM.ObjectModel.ProxyOwnProperty",
       ["QuickBEAM.VM.ObjectModel.OwnProperty", "QuickBEAM.VM.ObjectModel.InternalMethods"]},
      {"QuickBEAM.VM.ObjectModel.ProxyPrototype",
       ["QuickBEAM.VM.ObjectModel.Prototype", "QuickBEAM.VM.ObjectModel.InternalMethods"]},
      {"QuickBEAM.VM.ObjectModel.ProxySet",
