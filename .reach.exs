...
[
  ...
  boundaries: [
    ...
    internal_callers: [
      ...
      {"QuickBEAM.VM.Runtime.ConstructorProperties",
       ["QuickBEAM.VM.ObjectModel.Get", "QuickBEAM.VM.ObjectModel.BuiltinFunctionGet"]},
      {"QuickBEAM.VM.Interpreter.Completion",
       [
         "QuickBEAM.VM.Interpreter.Ops.ArrayElements",
         "QuickBEAM.VM.Interpreter.Ops.CopyDataProperties",
      ...
      {"QuickBEAM.VM.ObjectModel.BuiltinFunctionGet", ["QuickBEAM.VM.ObjectModel.Get"]},
      ...
      {"QuickBEAM.VM.ObjectModel.FunctionPrototypeGet", ["QuickBEAM.VM.ObjectModel.Get"]},
