...
- Remove integer-index keys from redundant object insertion-order lists and bulk-build literal arrays in one heap update, preserving exact logical accounting while eliminating quadratic array-order allocation.
