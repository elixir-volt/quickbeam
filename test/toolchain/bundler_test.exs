defmodule QuickBEAM.Toolchain.BundlerTest do
  ...
  describe "bundle_file" do
    ...
    @tag :tmp_dir
    test "falls back to an ancestor node_modules directory", %{tmp_dir: dir} do
      setup_fake_package(dir, "outer-package", %{
        "package.json" => ~s({"name":"outer-package","module":"dist/index.js"}),
        "dist/index.js" =>
          "import { value } from 'hoisted-package'; export const result = value + 1;",
        "node_modules/nested-only/package.json" => ~s({"name":"nested-only"})
      })

      setup_fake_package(dir, "hoisted-package", %{
        "package.json" => ~s({"name":"hoisted-package","module":"index.js"}),
        "index.js" => "export const value = 41;"
      })
