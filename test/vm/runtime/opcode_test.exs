defmodule QuickBEAM.VM.Runtime.OpcodeTest do
  ...
  test "constructor opcodes allocate instances through canonical invocation semantics" do
    ...
    {:ok, execution} = Property.define(constructor, "prototype", prototype, execution)
  ...
  test "object opcodes return resumable getter and setter actions" do
    ...
    {:ok, execution} = Property.define_accessor(object, "value", :getter, getter, execution)
    {:ok, execution} = Property.define_accessor(object, "value", :setter, setter, execution)
  ...
  test "object opcodes allocate arrays and enumerate canonical property order" do
    ...
    assert {:ok, 1} = Property.get(array, 0, execution)
    assert {:ok, 2} = Property.get(array, 1, execution)
