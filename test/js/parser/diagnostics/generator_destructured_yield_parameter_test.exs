defmodule QuickBEAM.JS.Parser.Diagnostics.GeneratorDestructuredYieldParameterTest do
  ...
  test "ports QuickJS generator destructured yield parameter diagnostics" do
