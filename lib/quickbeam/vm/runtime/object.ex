defmodule QuickBEAM.VM.Runtime.Object do
  ...
  non-default data descriptors retain full `QuickBEAM.VM.Runtime.Property.Descriptor` structs.
  ...
  @type stored_property :: QuickBEAM.VM.Runtime.Property.Descriptor.t() | {term()}
  @type t :: %__MODULE__{
          kind: kind(),
          prototype: QuickBEAM.VM.Runtime.Reference.t() | nil,
  ...
  @spec property_descriptor(stored_property() | nil) ::
          QuickBEAM.VM.Runtime.Property.Descriptor.t() | nil
  def property_descriptor({value}), do: %QuickBEAM.VM.Runtime.Property.Descriptor{value: value}
  def property_descriptor(%QuickBEAM.VM.Runtime.Property.Descriptor{} = property), do: property
  ...
  def property_enumerable?(%QuickBEAM.VM.Runtime.Property.Descriptor{enumerable: enumerable}),
    do: enumerable
end
