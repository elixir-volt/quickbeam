defmodule QuickBEAM.VM.Compiler.GeneratedModule.CodeLifecycle do
  @moduledoc """
  ...
  alias QuickBEAM.VM.Compiler.GeneratedModule.{Artifact, ImportPolicy}
  ...
  def install(module, %Artifact{module: module, binary: binary} = artifact) do
    with :ok <- validate_module(module),
         ...
         :ok <- ImportPolicy.validate(binary),
