defmodule QuickBEAM.VM.Opcodes.Control do
  @moduledoc """
  ...
  alias QuickBEAM.VM.{Execution, Frame, PromiseReference, Value}
  ...
  @type action ::
          ...
          | {:return_async, term(), Execution.t()}
          | {:throw, term(), Frame.t(), Execution.t()}
          | {:await_promise, PromiseReference.t(), Frame.t(), Execution.t()}
          | {:await_legacy, reference(), Frame.t(), Execution.t()}
          | {:await_immediate, {:ok, term()} | {:error, term()}, Frame.t(), Execution.t()}
