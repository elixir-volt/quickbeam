defmodule QuickBEAM.VM.Measurement do
  ...
  are lifecycle observations. `compiler_regions` contains bounded sampled
  heavy hitters only when the explicit region probe is enabled.
  `process_memory_bytes` and `reductions` are
