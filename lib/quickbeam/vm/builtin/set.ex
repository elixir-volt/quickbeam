defmodule QuickBEAM.VM.Builtin.Set do
  ...
  def values(%Call{this: %Reference{} = set, execution: execution}) do
    case Heap.fetch_object(execution, set) do
      {:ok, %Object{kind: :set, internal: %{values: values}}} ->
        ...
        {:ok, execution} =
          Property.define(next, "name", "next", execution,
            writable: false,
            enumerable: false,
            configurable: true
          )
        ...
        {:ok, execution} =
          Property.define(next, "length", 0, execution,
            writable: false,
            enumerable: false,
            configurable: true
          )
        ...
        {:ok, execution} =
          Property.define(iterator, "next", next, execution,
            writable: true,
            enumerable: false,
            configurable: true
          )
