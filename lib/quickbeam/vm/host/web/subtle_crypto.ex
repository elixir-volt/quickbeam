defmodule QuickBEAM.VM.Host.Web.SubtleCrypto do
  ...
  alias QuickBEAM.VM.Host.Web.Buffer

  @doc "Builds the SubtleCrypto object."
  def build_subtle do
    object do
      method "digest" do
        [algo_val, data_val] = argv(args, [nil, nil])
      ...
      method "generateKey" do
        [algo_val, _extractable, _key_usages] = argv(args, [nil, nil, nil])
      ...
      method "sign" do
        [algo_val, key_val, data_val] = argv(args, [nil, nil, nil])
        algo = normalize_algo(algo_val)
      ...
      method "verify" do
        [algo_val, key_val, sig_val, data_val] = argv(args, [nil, nil, nil, nil])
        algo = normalize_algo(algo_val)
        key_data = key_data_for_crypto(unwrap_key(key_val))
      ...
      method "deriveBits" do
        [algo_val, key_val, length_val] = argv(args, [nil, nil, nil])
        algo = normalize_algo(algo_val)
        key_data = key_data_for_crypto(unwrap_key(key_val))
      ...
      method "deriveKey" do
        [algo_val, key_val, derived_algo_val, extractable, _key_usages] =
          argv(args, [nil, nil, nil, nil, nil])
      ...
      method "importKey" do
        [format_val, data_val, algo_val, extractable, _key_usages] =
          argv(args, [nil, nil, nil, nil, nil])
      ...
      method "exportKey" do
        [format_val, key_val] = argv(args, [nil, nil])
        format = to_string(format_val)
