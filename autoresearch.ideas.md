...
- Fix semantic gaps before adding these cases to the invoked audited corpus:
  ...
  - Function atom tables are now keyed by function shape as well as bytecode, fixing repeated-bytecode callback families such as array `find`/`some`/`every` compiled before invocation.
