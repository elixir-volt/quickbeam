...
- Fresh semantic divergences seen during coverage broadening; fix before adding to clean audit:
  ...
  - `queueMicrotask`, proxy invariant enforcement, tag-call captured side effects/`raw` template strings, static block captured lexical writes, iterator close with captured lexical writes, and astral string edge cases beyond basic for-of/spread need product investigation before inclusion.
